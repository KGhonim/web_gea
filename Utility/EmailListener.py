...
class EmailListener:
    ...
    def close(self):
        ...
        send_email(self.SEND_EMAIL, self.SUBJECT, self.SMPT, self.FROM, self.PASSWORD, self.TO, self.CC,
         ...
         self.date_now, self.total_time, self.Project_NAME)
...
<body>
	<div class="rf-box">
		...
		<p style="padding-left:10px"> Hi Team,
			<br> Please find below test automation execution result for version: 2.6.0 - TG#94.
		...
		<table style="width:80%%;padding-left:20px">
			...
			<tr class="item">
				<td>Execuation Time</td>
				<td>%s</td>
			</tr>
		</table>
		<table>
			<tr>
				<td style="text-align: left;color: #FF0000; font-size: 20px">
				<br>
				<br>
					<p>This is automated email from Robot Framework test automation.</p>
				</td>
			</tr>
		</table>
	</div>
